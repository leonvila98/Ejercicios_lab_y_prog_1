...
int employee_calcularSueldo(Employee* this)
{
	int retorno=-1;
	int bufferHoras;
	...
	if(this!=NULL)
	{
		...
		if(bufferHoras<=120)
		{
			employee_setSueldo(this,bufferHoras*180);
		}
		else if(bufferHoras>120 && bufferHoras<=160)
		{
			employee_setSueldo(this,bufferHoras*240);
		}
		else if(bufferHoras>160 && bufferHoras<240)
		{
			employee_setSueldo(this,bufferHoras*350);
		}
	}
	return retorno;
}
