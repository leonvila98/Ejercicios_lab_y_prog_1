...
int main()
{
    ...
    strcpy(Marketing[2].archivo,"archivo.mp4");
    ...
    while(opcion!=8)
    {
        ...
        switch(opcion)
        {
            ...
            case 6:
            {
                burbujeoStructFloat(visores,1);
                pan_printPantalla(visores,LEN_LISTA);
                break;
            }
            case 7:
            {
                if(publicidadMenorADias(Marketing,visores,10,3)==0)
                {
                    printf("\nENTRO");
                }
                else
